...
from app.routers import compatibility, equity, prediction, ridership, routes, simulation
...
app = FastAPI(
    ...
    description=(
        "TransitLens backend API for GTFS, TTC ridership, Bike Share, "
        "predictions, equity, and disruption simulation."
    ),
)
